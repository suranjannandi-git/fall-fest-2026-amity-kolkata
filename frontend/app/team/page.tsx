export default function Team() {
  const team = [
    {
      name: "Prof. (Dr.) Indraneel Mukhopadhyay",
      role: "Professor",
      organization: "Amity Institute of Information Technology, Kolkata",
      image: "/organizer-Dr-Indraneel-Mukhopadhyay.jpeg",
    ...
    },
    {
      ...
      organization: "Amity Institute of Information Technology, Kolkata",
      image: "/organizer-Dr-Ambar-Dutta.jpeg",
      // bio: "Passionate about quantum computing and community building.",
      social: { linkedin: "#", github: "#", twitter: "#" }
    },
    {
      name: "Dr. Debarpita Santra",
      role: "Associate Professor",
      organization: "Amity Institute of Information Technology, Kolkata",
      image: "/organizer-Dr-Debarpita-Santra.jpeg",
      // bio: "Passionate about quantum computing and community building.",
      social: { linkedin: "#", github: "#", twitter: "#" }
    },
    {
      name: "Dr. Bannishikha Banerjee",
      role: "Associate Professor",
      organization: "Amity Institute of Information Technology, Kolkata",
      image: "/organizer-Dr-Bannishikha-Banerjee.jpeg",
      // bio: "Passionate about quantum computing and community building.",
      social: { linkedin: "#", github: "#", twitter: "#" }
    },
    {
      ...
      role: "PhD Student",
      organization: "Amity Institute of Information Technology, Kolkata",
      image: "/organizer-Suranjan-Nandi.jpeg",
      // bio: "Passionate about quantum computing and community building.",
      social: { linkedin: "#", github: "#", twitter: "#" }
    },
    {
      name: "Souryadipto Bhattacharyya",
      role: "PhD Student",
      organization: "Amity Institute of Information Technology, Kolkata",
      image: "/organizer-Souryadipto-Bhattacharyya.jpeg",
      // bio: "Passionate about quantum computing and community building.",
      social: { linkedin: "#", github: "#", twitter: "#" }
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap justify-center gap-8">
            {team.map((member, idx) => (
              <div
                key={idx}
                className=" bg-white rounded shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 border-t-4 border-[#dba921] w-full sm:w-[calc(50%-1rem)] lg:w-[calc(25%-1.5rem)] "
              >

                {/* Member Image */}
                <div className="h-80 bg-[#0f385f] overflow-hidden">
                  <img
                    src={member.image}
                    alt={member.name}
